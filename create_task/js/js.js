...
function onwards(row, col){
  ...
  game.innerHTML = contents[row][col] + restart;
}

var ch = 0, pt = 0;
var contents = [
  ['explain'],
  ['chapter 1', 'good choice', 'dead choice']
];
...
contents[1][0] = "<p>You trudge along, alone and hungry. You see you're in a forest, so perhaps you can find some berries, nuts, or roots, whatever those are. Story in progress.</p><button onclick='onwards(1, 1)'>Option 1</button><button onclick='onwards(1, 2)'>Option 2</button>"
contents[1][1] = "<p>Story in progress</p>";
contents[1][2] = "<p>Story in progress</p>";
