...
contents[4][0] = "<p>You and your friend make it to the castle, ready to face whatever may come. However, the strange backwards copy of your home is eerily quiet. You delve deeper into the castle, slowly and cautiously. So much for caution though, because as soon are you turn a corner, you're immediately faced with all of the evil twins of your own castle faculty back home. You regret not hiring people who weren't all that nice as you and you companion run away from the mini-army. You turn a sharp corner and hide your friend and yourself as the horde rushes by, though you won't remain hidden for long. The Riddler appears, asking, 'What has a bed but doesn't sleep and has a mouth but doesn't eat?'</p><input text='text' id='answer' placeholder='What is your answer?'/><button onclick='check()' id='answer-btn'>Answer</button>";
